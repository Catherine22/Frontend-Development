...
console.log('\nNumber');
let myNumber0 = Number.MIN_VALUE; // 5e-324 means the smallest fraction which is bigger than 0
let myNumber1 = Number.MAX_VALUE; // 1.7976931348623157e+308
let myNumber2 = -Number.MAX_VALUE * Number.MAX_VALUE; // -Infinity
let myNumber3 = Infinity;
let myNumber4 = 'abc' * 'def'; // NaN
let myNumber5 = NaN;
let myNumber6 = 0.1 + 0.2;
